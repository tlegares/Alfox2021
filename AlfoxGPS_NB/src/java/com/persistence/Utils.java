...
public final class Utils {
    ...
    static private SimpleDateFormat staticDateFrench = new SimpleDateFormat("dd/MM/yyyy");
    /**
...
/*  ------------------------ Debug functions -----------------------------  */
    ...
    static public String formatTimestampDate(Timestamp _date) {
        return staticDateFrench.format((Date) _date);
    }
    ...
    public static void main(String[] argv) {
        System.out.println((encryptPassword("responsable")));
    }
}
